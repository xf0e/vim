...
hi DiffDelete   guifg=#ff8097 guibg=#5f1610          ctermfg=4        ctermbg=5
...
hi StatusLine   guifg=bg      guibg=DarkMagenta   gui=bold ctermfg=bg       ctermbg=DarkMagenta cterm=bold
